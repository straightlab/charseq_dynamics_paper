---
title: "Visualization : differentially expressed caRNA"
output:
...
## Exons mRNAs lncRNAs
```{r, fig.width=7.6, fig.height=4.1}
...
## UTL
```{r, fig.width=7.7, fig.height=7.5}
...
## Exons, Introns
```{r, fig.width=3.6, fig.height=1.9}
p<- plot_hist_deg(
        exprdata %>%
...
## UTL
```{r, fig.width=3.3, fig.height=3.5}
p<- plot_hist_deg(
        exprdata %>%
